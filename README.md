# 🛡️ UCX Browser v3.0.0 - Privacy-First Chromium
...
[![Version](https://img.shields.io/badge/version-3.0.0-blue.svg)](https://github.com/KGECMD/UCX-Browser/releases)
[![Privacy](https://img.shields.io/badge/privacy-maximum-green.svg)](PRIVACY.md)

## 🔒 Privacy Features - Maximum Protection v3.0
...
|----------|------|--------|
| Windows x64 | UCX-Browser-v3.0.0-Windows-x64.zip | ✅ Ready |
| Linux x64 | UCX-Browser-v3.0.0-Linux-x64.tar.xz | ✅ Ready |
| macOS | UCX-Browser-v3.0.0-macOS.dmg | ✅ Ready |
...
### Windows
1. Download `UCX-Browser-v3.0.0-Windows-x64.zip`
2. Extract anywhere
3. Run `UCX-Browser.exe` or `Setup.bat`

### Linux
```bash
tar -xf UCX-Browser-v3.0.0-Linux-x64.tar.xz
...
| `UCX-Browser.vbs` | VBScript launcher with icon |
| `UCX-Browser-Portable.exe` | Portable mode launcher |
| `Setup.bat` | Enhanced installer with UCX icon shortcuts |
| `README.txt` | Quick start guide |
| `UCX-INFO.txt` | Privacy manifest |
| `ucx.ico` | Custom UCX icon (256x256) |
| `ucx_*.png` | Icons in various sizes |
| `ucx_logo.svg` | UCX shield logo |
